...
<table>
<tr><td colspan="2">Formulario de alteraçao do Administrador </td> </tr>
<tr><td>Nome:
<tr><td><input type="text" name="txtnome"  value="<?=$nome?>" required > </td></tr>
<tr><td>login:</tr></td>
<tr><td><input name="txtlogin" type="text" id="tx_email" size="52" maxlength="150" class="formbutton" value="<?=$login?>" required></td></tr>
<tr><td>senha:
<tr><td><input name="txtsenha" type="password" class="formbutton" id="tx_nome" size="52" maxlength="150" value="<?=$senha?>" required></td></tr>
