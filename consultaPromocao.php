...
<body>
<form method = "post" action = "consultaPromocao.php">
    ...
    <table  class = "tableconsulta">
        ...
        try{
            ...
            $sql = "SELECT * FROM promocao WHERE nome LIKE? ORDER BY nome";
            ...
            if($stmt){
                foreach($stmt as $usr){
                    ...
                    echo  "</td>";
                    echo "<td>";
                    echo "<a href = 'deletaPromocao.php?idCodigo=".$usr["idCodigo"]."'onclick = 'return deletaproduto(".$usr["idCodigo"].")'> Excluir </a>";
                    echo "</td>";
                    echo"</tr>";
                }
            }
